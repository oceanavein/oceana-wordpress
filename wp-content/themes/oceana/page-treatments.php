...
<section class="treatments-image">
	...
	<img
		src="<?php echo $image["sizes"]['full-width-image']; ?>"
		...
		<?php if( have_rows('treatments') ): ?>
		    ...
		    <?php while ( have_rows('treatments') ) : the_row(); ?>
		        ...
		        <div class="body-content">
		          ...
		          <p>
								<a href="<?php the_sub_field('page_link'); ?>" class="cta-link">
									Learn More
								</a>
							</p>
		        </div>
  ...
  <div class="container">
		...
		<div class="md:flex gap-10">
			<div class="col-span-6">
				<h3 class="section-title text-h2">
					<?php the_field('payment_section_title'); ?>
				</h3>
				<div class="body-content">
		      <p>
						<?php the_field('payment_section_content'); ?>
					</p>
				</div>
			</div>
